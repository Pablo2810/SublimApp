...
public class DatosTela {
    ...
    public DatosTela(Long id, TipoTela tipoTela, Double metros, String color) {
        this.id = id;
        this.tipoTela = tipoTela;
        this.metros = metros;
        this.color = color;
    ...
    public DatosTela(Long id, TipoTela tipoTela, Double metros, String color, String imagenUrl) {
        this.id = id;
        this.tipoTela = tipoTela;
        this.metros = metros;
        this.color = color;
